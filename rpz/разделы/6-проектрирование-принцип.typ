...
Технологии КМОП и ТТЛ представляют собой два принципиально различных класса логических интегральных схем: ТТЛ основано на биполярных транзисторах, а КМОП -- на полевых МОП-транзисторах. При этом ТТЛ обладает высокой скоростью переключения, но значительным статическим потреблением, тогда как КМОП обеспечивает низкий ток покоя, высокую помехозащищённость и широкий диапазон питающих напряжений.

Согласно ТЗ, для разрабатываемого устройства необходимо применять КМОП-логику с учётом приоритетов быстродействия и суммарной потребляемой мощности. Выбор элементной базы производится на основе анализа характеристик отечественных серий: К561, КР1561 и К564. В таблице @табл-срав представлено сравнение элементов разных серий.
...
Микросхема 1564ЛН1 (ЭП, корпус 401.14-5) представляет собой шесть логических элементов инвертор (НЕ). Информационными входами являются 1, 3, 5, 9, 11, 13.Информационными выходами являются выводы 2, 4, 6, 8, 10, 12. Вывод 7 — «общий», вывод 14 — питание. Микросхема изображена на рисунке @1564ЛН1.

#рис(image("../УГО/1564ЛН1.png",height: 35%))[ Микросхема 1564ЛН1 ] <1564ЛН1>
...
#рис(image("../УГО/К561КТ3.png"))[ Микросхема К561КТ3 ] <К561КТ3>
...
#рис(image("../УГО/1564ТМ8.png",height: 35%))[ Микросхема КР1564ТМ8 ] <1564ТМ8>
